...
exports.broadcast = async (message) => {
  try {
    ...
    const response = await axios.post(url, {
      ...
      headers: {
        'Authorization': `Bearer uEzs8kBmt8tcv3vxR0Vm9VfdEXHQemt+UEExYcS3IBxXtKrjdLE41HQNcywelzaEkBtkYFJNYjXdOF7qPVD0btoW7KPZVxGz0DD8epnhHiZsa9PU8E5tD/v7crAq+a9zPTz377DWCuZNPHSdlxyDaQdB04t89/1O/w1cDnyilFU=`,
        'Content-Type': 'application/json'
      }
    });
    return response.data;
